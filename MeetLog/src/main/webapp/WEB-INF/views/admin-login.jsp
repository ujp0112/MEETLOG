	...
	<div class="max-w-md w-full space-y-8 p-4">
		<div>
			<h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
				관리자 로그인</h2>
			<p class="mt-2 text-center text-sm text-gray-600">MEET LOG 관리자
				시스템</p>
		</div>
		...
		<form class="mt-8 space-y-6"
			...
			<div class="rounded-md shadow-sm -space-y-px">
				<div>
					<label for="email" class="sr-only">관리자 이메일</label> <input
			...
			<div class="text-center">
				<a href="${pageContext.request.contextPath}/"
					class="text-indigo-600 hover:text-indigo-500"> 메인 페이지로 돌아가기 </a>
			</div>
		</form>
	</div>
