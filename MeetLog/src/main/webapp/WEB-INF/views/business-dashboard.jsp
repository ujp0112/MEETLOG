        ...
        <main class="flex-grow">
            <div class="container mx-auto p-4 md:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="glass-card p-6 rounded-2xl slide-up"><dl><dt class="text-sm font-medium text-gray-500 truncate">월 매출</dt><dd class="text-3xl font-semibold text-gray-900 mt-1"><fmt:formatNumber value="${monthlyRevenue}" type="currency" currencySymbol="₩"/></dd></dl></div>
