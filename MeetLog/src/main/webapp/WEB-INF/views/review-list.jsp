								...
								<div class="bg-white p-6 rounded-xl shadow-lg">
									<div class="flex items-start justify-between mb-4">
										<div class="flex-grow">
											...
											<p class="text-slate-500 text-sm">맛집 ID:
												${review.restaurantId}</p>
										</div>
										<div class="text-right">
											...
											<div class="flex items-center text-sky-600">
												<button onclick="likeReview(${review.id})"
													...
													<span>❤️</span> <span class="text-sm">${review.likes}</span>
												</button>
											</div>
										</div>
									</div>
									<div
										...
										<a
											...
											class="text-sky-600 hover:text-sky-700 text-sm font-medium">맛집
											보기</a> <a
											href="${pageContext.request.contextPath}/review/detail/${review.id}"
											class="text-slate-600 hover:text-slate-700 text-sm font-medium">자세히
											보기</a>
									</div>
								</div>
							</c:forEach>
