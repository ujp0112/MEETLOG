...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto py-12 px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <form id="restaurantForm" action="${pageContext.request.contextPath}/business/restaurants/add" method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="border-t pt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="form-input mt-1" placeholder="가게에 대한 상세한 설명을 입력해주세요. (예: 주차 정보, 가게 특징 등)"></textarea>
                    </div>
                    ...
                    <div>
                         <div class="flex justify-between items-center">
                            <label class="block text-sm font-medium text-gray-700">예약 시간 구성 (DB 저장용)</label>
        ...
        $(document).ready(function() {
            ...
            $('#hours-container').on('click', '.add-slot-btn', function() {
                ...
                $slotsContainer.find('.time-slot').each(function() {
                    const name = $(this).find('input.hidden-time-input').attr('name');
            ...
            $('#applyToAllBtn').on('click', function() {
                ...
                $('.day-wrapper').not('#day_1_wrapper').each(function() {
                    ...
                    if (!isClosed) {
                        ...
                        const $templateSlot = $('#day_1_wrapper .time-slot:first').clone(); // 깨끗한 템플릿 복제
