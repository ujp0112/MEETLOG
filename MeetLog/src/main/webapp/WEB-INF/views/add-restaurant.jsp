...
<body class="bg-gray-100">
            ...
            <form id="restaurantForm"
                ...
                <div class="border-t pt-6 space-y-6">
                    <div>
                        ...
                        <input type="text" id="phone" name="phone" class="form-input mt-1" placeholder="예: 02-1234-5678">
                    </div>
                    <div>
                                            ...
                                            <select name="day_${day}_open_1_time" class="time-select form-select">
                                                <c:forEach var="h" begin="0" end="11">
                                                    <c:forEach var="m" begin="0" end="30" step="30">
                                                        ...
                                                        <c:set var="timeValue" value="${String.format('%02d:%02d', hour, m)}" />
                                            ...
                                            <select name="day_${day}_close_1_time" class="time-select form-select">
                                                <c:forEach var="h" begin="0" end="11">
                                                    <c:forEach var="m" begin="0" end="30" step="30">
                                                        <c:set var="hour" value="${h == 0 ? 12 : h}" />
                                                        <c:set var="timeValue" value="${String.format('%02d:%02d', hour, m)}" />
                                                        <option value="${timeValue}" ${h == 10 && m == 0 ? 'selected' : ''}>${timeValue}</option>
                                                    </c:forEach>
                                                </c:forEach>
                                            </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            // 페이지 로드 시 모든 hidden input 초기값 설정
            $('.time-select').trigger('change');
        });
    </script>
</body>
