        ...
        <main id="main-content" class="flex-grow bg-slate-50">
            <div class="mx-auto w-full max-w-6xl px-4 py-10 md:px-6 md:py-14">
                ...
                <c:choose>
                                            ...
                                            <c:if test="${not empty course.author}">
                                                <div class="flex flex-wrap items-center gap-3 text-sm text-white/80">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs uppercase tracking-wide text-white/60">코스 작성자</p>
                                                    </div>
                                                </div>
                                            </c:if>
                                        </div>
                            ...
                            <div class="grid gap-10 lg:grid-cols-[minmax(0,2.5fr)_minmax(0,1fr)]">
                                <div class="space-y-10">
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-3">
                                        <div class="stat-card">
                                            ...
                                            <p class="meta-value"><c:out value="${stepCount}"/>곳</p>
                                    ...
                                    <section class="subtle-card space-y-6">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <p class="rounded-2xl bg-slate-50 p-6 text-center text-sm text-slate-500">등록된 코스 단계가 없습니다.</p>
                                            </c:otherwise>
                                        </c:choose>
                                    </section>
                                    ...
                                    <section class="subtle-card space-y-6" id="comment-section">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="rounded-full bg-slate-100 px-4 py-1 text-sm font-semibold text-slate-500"><c:out value="${courseCommentCount}" default="0"/>개</span>
                                        </div>
                                        ...
                                        <c:choose>
                                                                ...
                                                                <div class="flex-1 space-y-2">
                                                                    <div class="flex items-start justify-between">
                                                                        ...
                                                                        <div class="flex gap-2 text-xs text-slate-400">
                                                                            <c:if test="${not empty sessionScope.user && sessionScope.user.id == comment.userId}">
                                                                                <button type="button" class="edit-comment-btn hover:text-sky-600" data-comment-id="${comment.id}">수정</button>
                                                                                <button type="button" class="delete-comment-btn hover:text-red-500" data-comment-id="${comment.id}">삭제</button>
                                                                            </c:if>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="comment-edit-form hidden space-y-3">
                                                                        ...
                                                                        <div class="flex gap-2">
                                                                            <button type="button" class="save-edit-btn rounded-lg bg-sky-600 px-3 py-1 text-sm text-white hover:bg-sky-700" data-comment-id="${comment.id}">저장</button>
                                                                            <button type="button" class="cancel-edit-btn rounded-lg bg-slate-300 px-3 py-1 text-sm text-slate-700 hover:bg-slate-400">취소</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <c:otherwise>
                                                <p class="rounded-2xl bg-slate-50 p-6 text-center text-sm text-slate-500">아직 댓글이 없습니다. 첫 댓글을 남겨보세요!</p>
                                            </c:otherwise>
                                        </c:choose>

                                        <c:if test="${not empty sessionScope.user}">
                                            <form id="comment-form" class="space-y-3">
                                                <textarea id="comment-content" class="w-full min-h-[120px] rounded-xl border border-slate-300 bg-white p-3 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500" maxlength="500" placeholder="댓글을 입력해주세요."></textarea>
                                                <div class="flex justify-end">
                                                    <button type="submit" class="rounded-lg bg-sky-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-sky-700">댓글 등록</button>
                                                </div>
                                            </form>
                                        </c:if>
                                        ...
                                        <c:if test="${empty sessionScope.user}">
                                            <p class="text-center text-sm text-slate-500">
                                                댓글을 작성하려면 <a href="${pageContext.request.contextPath}/login" class="font-semibold text-sky-600 hover:underline">로그인</a>이 필요합니다.
                                            </p>
                                        </c:if>
                                    </section>
                                </div>
                                ...
                                <aside class="space-y-6">
                                    <div class="stat-card space-y-4">
                    	                <h3 class="text-lg font-semibold text-slate-900">코스 한눈에 보기</h3>
                                        <ul class="space-y-3 text-sm text-slate-600">
                                            <li class="flex items-center justify-between">
                                                <span class="text-slate-500">총 스탑</span>
                                                <span class="font-semibold text-slate-900"><c:out value="${stepCount}"/>곳</span>
                                            </li>
                                            <li class="flex items-center justify-between">
                                                <span class="text-slate-500">좋아요</span>
                                        ...
                                        <div class="stat-card space-y-4">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/feed/user/${course.userId}" class="text-xs text-slate-500 hover:text-sky-600">프로필 살펴보기 →</a>
                                                </div>
                                            </div>
                                            <p class="text-xs text-slate-500">작성자를 팔로우하면 새로운 코스와 리뷰를 빠르게 받아볼 수 있어요.</p>
                                        </div>
                                    </c:if>
                                </aside>
                            </div>
                    ...
                    <c:otherwise>
                        <p class="rounded-2xl bg-white p-8 text-center text-lg font-semibold shadow">해당 코스를 찾을 수 없습니다.</p>
                    </c:otherwise>
                </c:choose>
