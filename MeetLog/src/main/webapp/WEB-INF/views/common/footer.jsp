...
<footer class="bg-sky-600 text-blue-200">
  <div class="mx-auto max-w-7xl px-4 py-14">
    ...
    <div class="flex flex-col gap-12 lg:flex-row lg:justify-between">
      ...
      <div class="max-w-md space-y-6">
        <div>
          ...
          <p class="mt-2 text-sm">맛있는 순간을 기록하고 공유하는 미식 플랫폼 MEET LOG<br>취향과 데이터를 연결해 실패 없는 만남을 함께 하세요</p>
        </div>
    ...
    <div class="mt-16 border-t border-indigo-500/50 pt-8 text-center text-xs text-indigo-200 sm:flex sm:items-center sm:justify-between sm:text-left">
