							...
							<div class="dropdown-content absolute right-0 top-full pt-4 hidden group-hover:block z-50">
								<div class="min-w-[200px] bg-white rounded-md shadow-lg py-2 border border-slate-200">
									...
									<c:if test="${sessionScope.businessUser.role.toUpperCase() == 'BRANCH'}">
										<div class="my-1 border-t border-slate-200"></div>
										<div class="px-4 py-2 text-sm font-semibold text-slate-500">지점(BRANCH) 메뉴</div>
										<a href="${pageContext.request.contextPath}/branch/inventory" class="block px-4 py-2 text-slate-700 hover:bg-slate-100">🏪 지점 재고 관리</a>
