...
<body>
<%@ include file="/WEB-INF/jspf/header.jspf" %>	<main>
						...
						<tbody>
									...
									<td>
										<div class="row-actions">
											...
											<button type="button" class="btn-sm btn-danger"
												data-action="delete"
												data-delete-url="${contextPath}/hq/menus/${m.num}/delete">삭제</button>
										</div>
									</td>
								</tr>
							</c:forEach>
							<c:if test="${empty menus}">
								...
								<tr id="row-m2" data-id="m2" data-name="방울토마토"
									data-saleprice="100000" data-unitprice="3200" data-step="10"
									data-qty="150" data-img="">
									<td><span class="thumb"
										style="display: grid; place-items: center">🍅</span></td>
									<td>방울토마토</td>
									<td>100000</td>
								...
								<tr id="row-m5" data-id="m5" data-name="올리브오일" data-unit="L"
									data-unitprice="9800" data-step="1" data-qty="8" data-img="">
									<td><span class="thumb"
										style="display: grid; place-items: center">🫒</span></td>
									<td>올리브오일</td>
									<td>L</td>
		...
		<div class="dialog">
			...
			<div class="bd">
				<form id="editForm" class="form"
					action="${contextPath}/hq/menus/edit" method="post"
	...
	<div id="appendModal" class="modal" aria-hidden="true" role="dialog"
		...
		<div class="dialog">
			...
			<div class="bd">
				<form id="appendForm" class="form" action="${contextPath}/hq/menus"
