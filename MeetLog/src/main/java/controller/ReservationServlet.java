...
public class ReservationServlet extends HttpServlet {
	...
	private OperatingHourService operatingHourService = new OperatingHourService(); // OperatingHourService 추가
