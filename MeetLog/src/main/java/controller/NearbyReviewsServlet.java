...
@WebServlet("/search/nearby-reviews")
public class NearbyReviewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Review> reviews = dao.findNearbyReviewsByPage(lat, lng, radiusKm, offset, PAGE_SIZE);
